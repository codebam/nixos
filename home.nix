...

{
  ...
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kcm_touchpad"."Toggle Touchpad" = ["Meta+Ctrl+Zenkaku Hankaku" "Meta+Ctrl+Touchpad Toggle" "Touchpad Toggle\\\\, Touchpad Toggle" "" "" "\\,Touchpad Toggle" "Touchpad Toggle" "Meta+Ctrl+Touchpad Toggle" "Meta+Ctrl+Zenkaku Hankaku"];
    ...
    configFile = {
      ...
      "baloofilerc"."General"."folders\x5b$e\x5d" = "$HOME/Documents/,$HOME/Downloads/,$HOME/Pictures/";
      ...
      "kwinrc"."Tiling/b2559065-88e5-5b53-86c7-cab85d2c57e6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
      ...
      "spectaclerc"."ImageSave"."lastImageSaveAsLocation" = "file:///home/codebam/Pictures/Screenshots/Screenshot_20250228_113524.png";
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/codebam/Pictures/Screenshots/Screenshot_20250228_113524.png";
      "spectaclerc"."ImageSave"."translatedScreenshotsFolder" = "Screenshots";
      "spectaclerc"."VideoSave"."translatedScreencastsFolder" = "Screencasts";
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///run/media/codebam/7d57a643-ac36-4e54-b873-0e19bd8a8645/SteamLibrary/steamapps/compatdata/232090/pfx/drive_c/users/steamuser/Documents/My Games/KillingFloor2/KFGame/Config/GFXSettings.KFGame.xml";
