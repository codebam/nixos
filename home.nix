...

{
  ...
  wayland.windowManager.sway = let
    wallpaper = builtins.fetchurl {
      url =
        "https://images.hdqwalls.com/download/1/beach-seaside-digital-painting-4k-05.jpg";
      sha256 =
        "2877925e7dab66e7723ef79c3bf436ef9f0f2c8968923bb0fff990229144a3fe";
    };
    modifier = "Mod4";
  in {
    extraConfigEarly = ''
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-59e4c893-6fbd-4725-91df-50a7f3c4589c" =
        "none";
      ...
      "kwin"."view_zoom_in" =
        [ "Meta++" "Meta+x3d\\,Meta++" "Meta+x3d\\,Zoom In" ];
    ...
    configFile = {
      ...
      "kcminputrc"."Libinput/1133/49291/Logitech G502 HERO Gaming Mouse"."PointerAccelerationProfile" =
        1;
      ...
      "kwinrc"."org.kde.kdecoration2"."theme" =
        "__aurorae__svg__WhiteSur-Sharp-dark";
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasmanotifyrc"."Applications/com.discordapp.Discord"."Seen" = true;
      "plasmanotifyrc"."Applications/com.discordapp.DiscordCanary"."Seen" =
        true;
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorColumn" =
        108;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorLine" =
        51;
  ...
  services = {
    ...
    mopidy = {
      ...
      settings = {
        ytmusic = { oauth_json = "/home/codebam/Downloads/oauth.json"; };
      };
    };
  };
